  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `task` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `description` TEXT, `category` TEXT, `notificationInterval` TEXT, `due_date` INTEGER)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"652483ec2fba796383e4fdcf9ecc2b22\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsTask.put("category", new TableInfo.Column("category", "TEXT", false, 0));
        _columnsTask.put("notificationInterval", new TableInfo.Column("notificationInterval", "TEXT", false, 0));
        _columnsTask.put("due_date", new TableInfo.Column("due_date", "INTEGER", false, 0));
        ...
        if (! _infoTask.equals(_existingTask)) {
          throw new IllegalStateException("Migration didn't properly handle task(com.example.intern.todo.model.Task).\n"
                  + " Expected:\n" + _infoTask + "\n"
                  + " Found:\n" + _existingTask);
        }
      }
    }, "652483ec2fba796383e4fdcf9ecc2b22", "ad8bf35d8cde86101b0af4e0e40f3c4f");
